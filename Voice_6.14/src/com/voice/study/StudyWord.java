	...
	public void onClick(View v) {
		...
		if (v==nextone){
			...
			if (attention.size()==0){
				...
				Toast.makeText(StudyWord.this, "�Ѽ������ʱ�", Toast.LENGTH_SHORT).show();
			}
			else Toast.makeText(StudyWord.this, "���ʱ����Ѱ���������ʣ�", Toast.LENGTH_SHORT).show();
			 ...
			 Dialog dialog = new AlertDialog.Builder(this)
	            ...
	            .setPositiveButton("ȷ��", new DialogInterface.OnClickListener() {
	                public void onClick(DialogInterface dialog, int whichButton) {
	            		...
	            		intent.setClass(StudyWord.this, StudyChoice.class);
	...
	private void UpdateView() {
		...
		if (currentnum<numoflist){
			...
			info.setText(list.get(currentnum).getPhonetic_alphabet()+"\n"+list.get(currentnum).getMeanning());
				...
				DataAccess data = new DataAccess(this);
				WordList wordlist=data.QueryList("BOOKID ='"+DataAccess.difficultyID+"'AND LIST = '"+listnum+"'", null).get(0);
